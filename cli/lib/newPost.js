...
function createBlogPost(outPath) {
    return __awaiter(this, void 0, void 0, function () {
        var answers, readline;
                                ...
                                readline.question('Header Image Alt: ', function (headerImageAlt) {
                                    ...
                                    readline.question('Header Image Caption: ', function (headerImageCaption) {
                                        ...
                                        for (var _i = 0, _a = Object.keys(answers); _i < _a.length; _i++) {
                                            var key = _a[_i];
                                            fileContents += "".concat(key, ": \"").concat(answers[key], "\"\n");
                                        }
                                        fileContents += '---';
                                        fs.writeFileSync("".concat(outPath, "/").concat(filename, ".mdx"), fileContents);
                                        readline.close();
                                    });
                                });
                            });
